...
from ppstructure.table.predict_table import TableSystem, to_excel, get_table_structure
                ...
                if region['label'] == 'table':
                    if self.table_system is not None:
                        ...
                        res, table_time_dict = self.table_system(
                            roi_img, return_ocr_result_in_table, custom_text_detector=custom_text_detector, 
                            custome_text_recognizer=custome_text_recognizer)
...
# TODO thainq: extract structure of table
def get_structure(res):
    res = res[0]
    tables = get_table_structure(res['res']['html'])
    return tables
