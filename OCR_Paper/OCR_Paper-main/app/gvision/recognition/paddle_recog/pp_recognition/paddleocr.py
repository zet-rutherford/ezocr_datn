...
class PaddleOCR(predict_system.TextSystem):
    def __init__(self, **kwargs):
        ...
        # # TODO thainq: add text detection model path
        # params.det_model_dir = '/app/model/text_detection/en_PP-OCRv3_det_infer/'
        # params.use_gpu = True
...
class PPStructure(StructureSystem):
    def __init__(self, **kwargs):
        ...
        # TODO thainq: determine model path
        params.det_model_dir = '/app/model/paddleocr/en_PP-OCRv3_det_infer/'
        ...
        # TODO thainq: determine model path
        params.rec_model_dir = '/app/model/paddleocr/latin_PP-OCRv3_rec_infer/'
        ...
        # TODO thainq: determine model path
        # params.table_model_dir = '/app/model/table_analysis/table_rec/ch_ppstructure_mobile_v2.0_SLANet_infer/'
        params.table_model_dir = '/app/model/table_analysis/table_rec/en_ppocr_mobile_v2.0_table_structure_infer/'
        params.table_char_dict_path = '/app/table_analyzer/pp_recognition/ppocr/utils/dict/table_structure_dict.txt'
        params.merge_no_span_structure = False
    ...
    def __call__(self, img, return_ocr_result_in_table=False, img_idx=0, custom_text_detector=None, custome_text_recognizer=None):
        img = check_img(img)
        res, _ = super().__call__(
            img, return_ocr_result_in_table, img_idx=img_idx, custom_text_detector=custom_text_detector, custome_text_recognizer=custome_text_recognizer)
        return res
